...
const Navbar = () => {
  ...
  useEffect(() => {
    if (
      vendorProfile?.available !== undefined &&
      vendorProfile?.available !== null
    ) {
          ...
          <div className="flex items-center justify-between px-2 lg:px-4 py-2  max-w-9xl mx-auto transition-all duration-1000">
            ...
            <div className="flex items-center gap-2 lg:gap-4">
              <button
                ...
                className="flex  justify-center items-center gap-1 p-1 lg:p-2 text-orange bg-gray-100 hover:bg-white/90 rounded-lg transition-all duration-200 hover:scale-105 active:scale-95 group backdrop-blur-sm border border-white/10 hover:border-white/30 cursor-pointer"
              >
